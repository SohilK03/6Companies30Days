class Solution {
    public String gcdOfStrings(String str1, String str2) {
        /*
         * this is a recursive solution which everytime eliminates
         * the shorter string from larger string and once the shorter is empty
         * we get our GCD (Greatest Common Divisor)
         */
